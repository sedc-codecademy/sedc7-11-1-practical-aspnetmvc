            ...
            modelBuilder.Entity("Lamazon.Domain.Models.Order", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new { Id = 2, Paid = false, Status = 2, UserId = 3 },
                        new { Id = 3, Paid = false, Status = 1, UserId = 4 }
                    );
                });
            ...
            modelBuilder.Entity("Lamazon.Domain.Models.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new { Id = 2, Address = "n/a", Firstname = "Stojanche", Lastname = "Mitrevski", Password = "123456", RoleId = 2, Username = "stojanche.m" },
                        new { Id = 3, Address = "Fake Street 69", Firstname = "Dejan", Lastname = "Blazheski", Password = "123456", RoleId = 3, Username = "dejan.blazheski" },
                        new { Id = 4, Address = "Fake Street 13 3/8", Firstname = "Dejan", Lastname = "Jovanov", Password = "123456", RoleId = 3, Username = "dejan.jovanov" }
                    );
                });
